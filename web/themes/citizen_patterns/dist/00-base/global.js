...
alert("wtf"),a(window).scroll(function(){var b=.8*a(window).height();a(this).scrollTop()>b?a(".back-anchor").fadeIn(200):a(".back-anchor").fadeOut(200)}),a(".back-anchor a").click(function(b){b.preventDefault(),a("html, body").animate({scrollTop:a("body").offset().top-10})})})}}})(jQuery,Drupal);
