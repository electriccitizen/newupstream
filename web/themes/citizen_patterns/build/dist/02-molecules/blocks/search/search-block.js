...
b.behaviors.searchToggle={attach:function attach(){a(".block-search-form-block").once("tSearch").each(function(){a(".t-search",this).click(function(b){//close main menu if open when search is clicked
