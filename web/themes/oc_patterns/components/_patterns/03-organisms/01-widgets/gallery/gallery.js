...
Drupal.behaviors.lightbox = {
	attach: function (context, settings) {
		$(".paragraph--type--gallery", context).once('lightboxes').each(function(){
			$('.featherlight-gal', this).lightboxGallery({
				previousIcon: '<',
				nextIcon: '>',
				galleryFadeIn: 300,
				openSpeed: 300
...
Drupal.behaviors.galleryFadeIn = {
	attach: function (context, settings) {
		$(".paragraph--type--gallery", context).once('randomBoxes').each(function(){
